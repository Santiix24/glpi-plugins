    ...
    <div class="ts-survey-body">
      ...
      <?php if ($saved || $alreadyDone): ?>
        ...
        <div class="ts-thanks-wrap">
          <div class="ts-thanks-icon">
            <?php if ($saved): ?>
              <i class="ti ti-circle-check" style="font-size:4rem;color:var(--ts-color,#4472C4)"></i>
            <?php else: ?>
              <i class="ti ti-info-circle" style="font-size:4rem;color:#64748b"></i>
            <?php endif; ?>
          </div>
